...
public class PropertyUtils {
	 ...
	 */
	public static void loadProperties(String resourcePath, String propertyType, Multimap<String, String> populatableMap) {
		Properties properties = new Properties();
		try (InputStream propStream = PropertyUtils.class.getResourceAsStream(resourcePath)) {
			properties.load(propStream);
			loadTermsPerGroup(properties, propertyType, populatableMap);
		} catch (Exception e) {
			System.out.println("Could not load institution property file: " + resourcePath);
			e.printStackTrace();
		}
	}
	 ...
	 */
	private static void loadTermsPerGroup(Properties properties, String propertyType, Multimap<String, String> populatableMap) {
